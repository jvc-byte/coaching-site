          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Access the Virtual Platform</h5>
                  <div class="row">
                    <div class="col">
                      ...
                      <ul>
                        <li>Log in to our virtual platform using your credentials.</li>
                        <li>Explore the program modules and resources.</li>
                      </ul>
                    </div>
                  </div>
                </div>
              </div>
            </div><!-- End Access the Virtual Platform -->
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="card-title fs-6">Guide</span>
                      <ul>
                        <li>Complete the self-paced modules covering various aspects of business growth.</li>
                        <li>Take quizzes and assessments to reinforce your knowledge.</li>
                      </ul>
                    </div>
                  </div>
                </div>
              </div>
            </div><!-- End Self-Paced Learning -->
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Webinars and Workshops</h5>
                  <div class="row">
                    <div class="col">
                      <p class="card-text">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatem quos
                        perspiciatis reprehenderit molestiae nulla provident iure culpa dolorum ipsa, qui sit soluta
                      ...
                      <span class="card-title fs-6">Guide</span>
                      <ul>
                        <li>Attend live webinars and workshops with industry experts.</li>
                        <li>Engage in Q&A sessions and discussions.</li>
                      </ul>
                    </div>
                  </div>
                </div>
              </div>
            </div><!-- End Webinars and Workshops -->
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Virtual Networking</h5>
                  <div class="row">
                    <div class="col">
                      <p class="card-text">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatem quos
                        perspiciatis reprehenderit molestiae nulla provident iure culpa dolorum ipsa, qui sit soluta
                      ...
                      <span class="card-title fs-6">Guide</span>
                      <ul>
                        <li>Connect with fellow participants through the virtual platform.</li>
                        <li>Join discussion forums and chat groups for networking opportunities.</li>
                      </ul>
                    </div>
                  </div>
                </div>
              </div>
            </div><!-- End Virtual Networking -->
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="card-title fs-6">Guide</span>
                      <ul>
                        <li>Schedule virtual coaching sessions with our experienced coaches.</li>
                        <li>Receive personalized guidance and feedback on your business.</li>
                      </ul>
                    </div>
                  </div>
                </div>
              </div>
            </div><!-- End Virtual Coaching -->
