<footer class="bd-footer py-2 py-md-5 mt-5">
        ...
        <div class="row">
            ...
            <div class="col-6 col-lg-2 mb-3">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2"><a href="#">App</a></li>
                    <li class="mb-2"><a href="#">Careers</a></li>
                    <li class="mb-2"><a href="#">Terms of Use</a></li>
                    <li class="mb-2"><a href="#">Privacy Policy</a></li>
                    <li class="mb-2"><a href="#">Accessibility Plan</a></li>
                </ul>
            </div>
            <div class="col-6 col-lg-2 mb-3">
                <h5>Projects</h5>
                <ul class="list-unstyled">
                    <li class="mb-2"><a href="#">Live Presentations</a></li>
                    <li class="mb-2"><a href="#">Online Presentations</a></li>
                </ul>
            </div>
            <div class="col-6 col-lg-2 mb-3">
                <h5>Community</h5>
